    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" action="/crud_upload" enctype="multipart/form-data">
                            @csrf
        
                            {{-- Nama Item --}}
                            <div class="form-group">
                                <label for="item_name">Nama Item :</label>
                                <input type="text" name="item_name" class="form-control @error('item_name') is-invalid @enderror" id="item_name" autofocus autocomplete="off" value="{{ old('item_name') }}">
