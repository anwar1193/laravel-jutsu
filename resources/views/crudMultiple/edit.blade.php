    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" action="/crud_multiple/{{ $data->id }}">
                            @method('put')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="trans_code" class="form-control @error('trans_code') is-invalid @enderror" id="trans_code" autofocus value="{{ old('trans_code', $data->trans_code) }}" readonly>
                                ...
                                <table class="table table-bordered" id="tableLoop">
                                    ...
                                    <tbody id="table_data">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control trans_product" name="trans_product[]">
                                                    @foreach ($product as $data)
                                                    <option value="{{ $data->id }}" {{ $data->id == $row->trans_product ? 'selected' : NULL }}>{{ $data->product_name }}</option>
                                                    @endforeach
                                                </select>
                                            </td>
