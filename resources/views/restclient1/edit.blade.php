    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
              <h3 class="box-title">Update Data to Rest Client 1</h3> <br>
            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    <form action="/rest_client1/{{ $data['id'] }}" method="post">
                        @method('put')
                        @csrf

                        <div class="form-group @error('username') has-error @enderror">
                            <label>Username :</label>
                            <input type="text" class="form-control" name="username" autocomplete="off" autofocus value="{{ old('username', $data['username']) }}">
                            @error('username')
